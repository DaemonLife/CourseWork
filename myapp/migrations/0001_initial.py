    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chair', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='myapp.chair', verbose_name='Кафедра')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('direction', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='myapp.direction', verbose_name='Направление')),
            ],
            options={
                'verbose_name': 'Группа',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.PositiveIntegerField(verbose_name='Количество')),
                ('group_parent', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, to='myapp.group', verbose_name='Родительская группа')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='myapp.group')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='myapp.group', verbose_name='Группы')),
                ('room', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, to='myapp.room', verbose_name='Аудитория')),
                ('teacher', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='myapp.teacher', verbose_name='Преподаватель')),
            ],
            options={
